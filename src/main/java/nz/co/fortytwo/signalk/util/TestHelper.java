...
import static nz.co.fortytwo.signalk.util.SignalKConstants.steering_autopilot_target_headingMagnetic;
import static nz.co.fortytwo.signalk.util.SignalKConstants.steering_autopilot_target_headingTrue;
...
public class TestHelper {
	...
	public static SignalKModel getOtherModel(){
		...
		other.getFullData().put(vessels+dot+"other"+dot+env_outside_pressure+dot+sourceRef , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_target_headingMagnetic+dot+sourceRef , UNKNOWN);
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_target_headingMagnetic+dot+timestamp , "2015-03-16T03:31:22.369Z");
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_target_headingMagnetic+dot+value , Math.toRadians(0d));
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_target_headingTrue+dot+sourceRef , UNKNOWN);
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_target_headingTrue+dot+timestamp , "2015-03-16T03:31:22.371Z");
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_target_headingTrue+dot+value , Math.toRadians(0d));
	...
	public static SignalKModel getBasicModel() {
		...
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_target_headingMagnetic+dot+sourceRef,UNKNOWN);
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_target_headingMagnetic+dot+timestamp,"2015-03-16T03:31:22.369Z");
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_target_headingMagnetic+dot+value, Math.toRadians(0d));
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_target_headingTrue+dot+sourceRef,UNKNOWN);
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_target_headingTrue+dot+timestamp,"2015-03-16T03:31:22.371Z");
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_target_headingTrue+dot+value, Math.toRadians(0d));
