...
public class TestHelper {
	...
	public static SignalKModel getOtherModel(){
		...
		other.getFullData().put(vessels+dot+"other"+dot+env_airPressure+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+env_airPressureChangeRateAlarm+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+env_waterTemp+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+env_wind_angleApparent+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+env_wind_directionChangeAlarm+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+env_wind_directionTrue+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+env_wind_speedAlarm+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+env_wind_speedApparent+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+env_wind_speedTrue+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+nav_anchor_maxRadius+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+nav_courseOverGroundMagnetic+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+nav_courseOverGroundTrue+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+nav_headingMagnetic+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+nav_headingTrue+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+nav_magneticVariation+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+nav_attitude_pitch+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+nav_rateOfTurn+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+nav_attitude_roll+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+nav_speedOverGround+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+nav_speedThroughWater+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+nav_state+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_backlash+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_deadZone+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_gain+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_headingSource+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_maxDriveCurrent+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_maxDriveRate+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_mode+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_portLock+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_starboardLock+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_state+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_targetHeadingMagnetic+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+steering_autopilot_targetHeadingNorth+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+steering_rudderAngle+dot+source , UNKNOWN);
		 ...
		 other.getFullData().put(vessels+dot+"other"+dot+steering_rudderAngleTarget+dot+source , UNKNOWN);
	...
	public static SignalKModel getBasicModel() {
		...
		basic.getFullData().put(vessels_dot_self_dot+env_airPressure+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+env_airPressureChangeRateAlarm+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+env_waterTemp+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+env_wind_angleApparent+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+env_wind_directionChangeAlarm+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+env_wind_directionTrue+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+env_wind_speedAlarm+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+env_wind_speedApparent+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+env_wind_speedTrue+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+nav_anchor_maxRadius+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+nav_courseOverGroundMagnetic+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+nav_courseOverGroundTrue+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+nav_headingMagnetic+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+nav_headingTrue+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+nav_magneticVariation+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+nav_attitude_pitch+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+nav_rateOfTurn+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+nav_attitude_roll+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+nav_speedOverGround+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+nav_speedThroughWater+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+nav_state+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_backlash+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_deadZone+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_gain+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_headingSource+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_maxDriveCurrent+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_maxDriveRate+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_mode+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_portLock+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_starboardLock+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_state+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_targetHeadingMagnetic+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+steering_autopilot_targetHeadingNorth+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+steering_rudderAngle+dot+source,UNKNOWN);
		...
		basic.getFullData().put(vessels_dot_self_dot+steering_rudderAngleTarget+dot+source,UNKNOWN);
